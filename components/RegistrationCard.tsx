  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <span className="flex size-12 items-center justify-center rounded-2xl bg-[#f1e6fa] text-[#ff9302]">
          <Icon className="size-6" />
        </span>
        <h3 className="text-2xl font-black text-[#28433b]">{item.title}</h3>
      </div>
      <p className="mt-5 flex-1 leading-7 text-[#65746f]">{item.description}</p>
      <span className="mt-8 inline-flex w-fit items-center gap-2 rounded-full bg-[#ff9302] px-5 py-3 font-bold text-white transition group-hover:gap-3 group-hover:bg-[#53217a]">
